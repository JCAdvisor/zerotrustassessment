                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                           Uma ferramenta de avaliação automatizada que avalia a postura de segurança Zero Trust do seu tenant Microsoft.
                        </p>
                    </div>

                    {/* Center Section - Links */}
                    {/* Center Section - Links<div className="space-y-4">
                        <h4 className="font-semibold text-foreground">Sobre JC2Sec</h4>
...
*\}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <a
                                href="https://jc2sec.com.br/#solucoes"
                                target="_blank"
                                rel="noreferrer noopener"
                                className="block text-sm text-muted-foreground hover:text-foreground transition-colors duration-200 hover:underline underline-offset-4"
                            >
                ...
                <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            © {new Date().getFullYear()} JC2Sec Cyber People Expert.
                        </p>
                    </div>
