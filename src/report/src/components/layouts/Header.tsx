        ...
        <header className="supports-backdrop-blur:bg-background/60 sticky top-0 z-50 w-full border-b bg-background/90 backdrop-blur">
            <div className="container px-4 md:px-8 flex h-20 items-center">
                <div className="mr-4 hidden md:flex">
                    <NavLink to="/" className="mr-12 flex items-center space-x-2">
                        <Logo />
                    </NavLink>
                    ...
                    <nav className="flex items-center space-x-2">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className='w-100' align='end' forceMount>
                                ...
                                <DropdownMenuLabel className='font-normal'>
                                    <div className='flex flex-col space-y-1'>
                                        <p className='text-sm font-medium leading-none'>ID do tenant</p>
                                        <p className='text-xs leading-none text-muted-foreground'>
                                            {reportData.TenantId}
                                        </p>
                                    </div>
                                ...
                                <DropdownMenuLabel className='font-normal'>
                                    <div className='flex flex-col space-y-1'>
                                        <p className='text-sm font-medium leading-none'>Avaliação gerada por</p>
                                        <p className='text-xs leading-none text-muted-foreground'>
                                            {reportData.Account}
                                        </p>
                                    </div>
