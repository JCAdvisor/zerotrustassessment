...
export const reportData: ZeroTrustAssessmentReport = {
  ...
  "Tests": [
    {
      "TestId": "24546",
      "TestResult": "\nA inscrição automática do Windows está habilitada.\n\n\n## Inscrição automática do Windows\n\n| Nome da política | Escopo do usuário |\n| :---------- | :--------- |\n| [Microsoft Intune](https://intune.microsoft.com/#view/Microsoft_AAD_IAM/MdmConfiguration.ReactView/appId/0000000a-0000-0000-c000-000000000000/appName/Microsoft%20Intune) | ✅ Grupos específicos |\n\n\n\n",
      "TestDescription": "Se a inscrição automática do Windows não estiver habilitada, dispositivos não gerenciados podem se tornar um ponto de entrada para invasores. Agentes mal-intencionados podem usar esses dispositivos para acessar dados corporativos, contornar políticas de conformidade e introduzir vulnerabilidades no ambiente. Dispositivos ingressados no Microsoft Entra sem inscrição no Intune criam lacunas de visibilidade e controle. Esses endpoints não gerenciados podem expor fragilidades no sistema operacional ou em aplicativos mal configurados que os invasores podem explorar.\n\nA imposição da inscrição automática garante que os dispositivos Windows sejam gerenciados desde o início, permitindo aplicação consistente de políticas e visibilidade sobre a conformidade. Isso dá suporte ao Zero Trust ao garantir que todos os dispositivos sejam verificados, monitorados e governados por controles de segurança.\n\n**Ação de remediação**\n\nHabilite a inscrição automática para dispositivos Windows usando o Intune e o Microsoft Entra para garantir que todos os dispositivos ingressados no domínio ou no Entra sejam gerenciados:  \n- [Habilitar a inscrição automática do Windows](https://learn.microsoft.com/intune/intune-service/enrollment/windows-enroll?wt.mc_id=zerotrustrecommendations_automation_content_cnl_csasci#enable-windows-automatic-enrollment)\n\nPara mais informações, consulte:  \n- [Guia de implantação - Inscrição para Windows](https://learn.microsoft.com/intune/intune-service/fundamentals/deployment-guide-enroll?tabs=work-profile%2Ccorporate-owned-apple%2Cautomatic-enrollment&wt.mc_id=zerotrustrecommendations_automation_content_cnl_csasci#enrollment-for-windows)\n",
      "TestSkipped": "",
      "TestTitle": "A inscrição automática de dispositivos Windows é obrigatória para eliminar riscos de endpoints não gerenciados",
      "TestStatus": "Passed",
      "TestTags": null,
      "TestRisk": "High",
      "TestPillar": "Devices",
