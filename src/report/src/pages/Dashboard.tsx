                ...
                <div className="grid w-full gap-6 lg:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col gap-1">
                                    <span className="text-sm text-muted-foreground">Domínio Primário</span>
                                    <span className="font-medium">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <div className="flex items-center gap-3 rounded-md border px-4 py-3">
                                    ...
                                    <div className="flex flex-col gap-0.5">
                                        <span className="text-muted-foreground text-sm font-medium">Convidados</span>
                                        <span className="text-lg font-medium">
                    ...
                    >
                        ...
                        <Card className="w-full lg:col-span-3 mt-6">
                            ...
                            <CardContent>
                                <DataTable columns={columns} data={reportData.Tests} isOverview/>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid w-full gap-6 lg:col-span-1">
                        ...
                        >
                            <CardHeader className="space-y-0 pb-2 flex-row">
                                ...
                                <CardTitle className="text-2xl tabular-nums">
                                    Métodos de autenticação de usuários privilegiados
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                                <ChartContainer
                        ...
                        >
                            <CardHeader className="space-y-0 pb-2 flex-row">
                                ...
                                <CardTitle className="text-2xl tabular-nums">
                                    Métodos de autenticação de todos os usuários
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                                <ChartContainer
                    ...
                    {reportData.TenantInfo?.DeviceOverview?.MobileSummary?.nodes && reportData.TenantInfo?.DeviceOverview?.ManagedDevices && (
                        <Card className="w-full lg:col-span-3">
                            ...
                            <CardFooter className="flex flex-row border-t p-4">
                                <div className="flex w-full items-center gap-2">
                                    <div className="grid flex-1 auto-rows-min gap-0.5">
                                        <div className="text-xs text-muted-foreground">Android Conformidade</div>
                                        <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                                            {(() => {
                                    ...
                                    <Separator orientation="vertical" className="mx-2 h-10 w-px" />
                                    <div className="grid flex-1 auto-rows-min gap-0.5">
                                        <div className="text-xs text-muted-foreground">iOS Conformidade</div>
                                        <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                                            {(() => {
                                                const nodes = reportData.TenantInfo?.DeviceOverview?.MobileSummary?.nodes || [];
