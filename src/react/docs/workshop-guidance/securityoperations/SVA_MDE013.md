...
ASR rules can be deployed using Microsoft Intune, Group Policy, Configuration Manager, or PowerShell. While a Windows E5 license provides advanced Auditoria and analytics through Microsoft Defender XDR, organizations with E3 or Pro licenses can still use Event Viewer or custom Auditoria solutions.
