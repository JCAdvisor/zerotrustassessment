# Govern discovered apps - Microsoft Defender for Cloud Apps
...
## Overview
The "Govern discovered apps" feature in Microsoft Defender for Cloud Apps allows organizations to manage and secure their environment by sanctioning safe apps and unsanctioning risky ones. This capability fits into the Zero Trust framework by enabling continuous Auditoria and control over app usage, ensuring that only trusted applications are used within the organization.
