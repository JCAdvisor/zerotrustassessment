...
**Implementation Effort:** Medium: Customer IT and Security Operations teams need to drive projects to set up and configure the Cloud Discovery dashboard and manage ongoing Auditoria and filtering of apps.
...
## Overview
The Cloud Discovery dashboard in Microsoft Defender for Cloud Apps provides insights into how cloud apps are being used within an organization. It offers a high-level overview of app types, usage, risk levels, and top users, fitting into the Zero Trust framework by enabling continuous Auditoria and management of app-related risks.
