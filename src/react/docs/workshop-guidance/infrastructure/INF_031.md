...
3. Under **Auditoria coverage**, choose the **Defender for Servers plan** and click **Settings**.
4. In **Settings and Auditoria**, turn on **Vulnerability assessment for machines**.
