...
For **Linux servers**, Microsoft provides an **installer script** that detects the OS distribution, configures the appropriate repository, installs the latest agent version, and onboards the Dispositivos using a downloaded onboarding package. This script can be executed manually or integrated into configuration management tools like **Ansible**, **Chef**, or **Puppet** [1](https://learn.microsoft.com/en-us/defender-endpoint/linux-installer-script).
