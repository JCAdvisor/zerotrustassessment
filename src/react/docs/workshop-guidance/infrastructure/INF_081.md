...
- **Deployment & Auditoria**: Ensures sensors are deployed and operational across all clusters, and flags unmonitored resources [1](https://learn.microsoft.com/en-us/azure/defender-for-cloud/defender-for-containers-introduction).
...
- Plan for continuous Auditoria and automated remediation.
