...
- **Plan 2** adds advanced features such as agentless scanning, vulnerability management, file integrity Auditoria, just-in-time access, and compliance assessments [1](https://learn.microsoft.com/en-us/azure/defender-for-cloud/plan-defender-for-servers-select-plan).
