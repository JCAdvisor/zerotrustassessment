...
1. **Block Access to Malicious or Unscanned Files**
   - Use Microsoft Entra ABAC (Attribute-Based Controle de Acesso) to restrict access based on scan results [1](https://learn.microsoft.com/en-us/azure/defender-for-cloud/defender-for-storage-configure-malware-scan).
...
- Ensure proper Controle de Acessos on quarantine containers to prevent unauthorized access.
