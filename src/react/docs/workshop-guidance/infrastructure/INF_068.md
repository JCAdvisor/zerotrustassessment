...
Enabling **registry access** in **Microsoft Defender for Containers** allows Defender to scan container images stored in external registries such as **Docker Hub**, **Google Artifact Registry**, and **Google Container Registry**. This enables vulnerability assessment and compliance Auditoria of container images before they are deployed into Kubernetes environments.
