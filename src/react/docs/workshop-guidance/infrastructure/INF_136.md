...
1. **Enable Threat Detection**  
   ...
   - This activates real-time Auditoria and alerting for supported database types [1](https://learn.microsoft.com/en-us/azure/defender-for-cloud/tutorial-enable-databases-plan).
