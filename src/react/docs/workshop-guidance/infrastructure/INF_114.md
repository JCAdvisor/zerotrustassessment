...
**Implementation Effort:** Medium — Requires coordination between security operations, IT, and compliance teams to define workflows, configure automation, and integrate with Auditoria tools.
...
2. **Investigation**
   ...
   - Review related alerts, affected users, Dispositivos, and storage accounts.
...
4. **Recovery**
   ...
   - Re-enable Controle de Acessos and validate that the threat has been removed.
