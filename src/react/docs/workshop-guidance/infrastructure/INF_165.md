...
- **Use Role-Based Controle de Acesso (RBAC)**: Ensures granular control over who can access and manage secrets, keys, and certificates [1](https://learn.microsoft.com/en-us/azure/defender-for-cloud/recommendations-reference-keyvault).
