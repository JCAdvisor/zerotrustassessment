...
Deploying **Azure Arc** in **Microsoft Defender for Containers** enables security Auditoria and protection for **on-premises** and **multicloud Kubernetes clusters**. Azure Arc acts as a bridge, allowing Defender for Containers to extend its capabilities—such as runtime threat detection, vulnerability scanning, and policy enforcement—to clusters outside of Azure.
...
This capability supports the **"Assume Breach"** and **"Verify Explicitly"** principles of Zero Trust by extending consistent security Auditoria and policy enforcement to Kubernetes clusters across hybrid and multicloud environments.
