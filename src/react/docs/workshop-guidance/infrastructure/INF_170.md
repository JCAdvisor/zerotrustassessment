...
- **Predefined Templates**: Use built-in query templates to quickly identify common risks, such as internet-exposed services with sensitive data or overly permissive Controle de Acessos [2](https://learn.microsoft.com/en-us/azure/defender-for-cloud/data-security-review-risks).
