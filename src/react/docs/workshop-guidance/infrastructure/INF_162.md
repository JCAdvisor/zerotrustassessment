...
- **Detect**: Identifies threats by Auditoria VM instances, management interfaces, and internal logs [2](https://learn.microsoft.com/en-us/azure/defender-for-cloud/defender-for-app-service-introduction).

Enabling this protection supports the **"Assume Breach"** principle of Zero Trust by continuously Auditoria for threats and providing actionable alerts. Without it, attacks on web applications may go undetected, increasing the risk of data breaches or service disruption.
