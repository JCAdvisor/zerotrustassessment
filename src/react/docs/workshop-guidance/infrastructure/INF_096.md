...
Microsoft Defender for Storage is a native Azure security solution that protects storage workloads such as Azure Blob Storage, Azure Files, and Azure Data Lake Storage. It provides advanced threat detection capabilities including malware scanning, sensitive data threat detection, and activity Auditoria. These features help identify and mitigate risks such as malicious uploads, data exfiltration, and unauthorized access.
...
This capability supports the Zero Trust principle of **"Assume Breach"** by continuously Auditoria for threats and anomalies in storage access and usage patterns.
