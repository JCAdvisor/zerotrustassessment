...
**Implementation Effort:** Medium – Requires enabling Defender for Containers and configuring Kubernetes policy and Auditoria settings.
...
2. **Enable Azure Policy for Kubernetes**:
   - In the **Settings & Auditoria** section, toggle **Azure Policy for Kubernetes** to **On** [2](https://learn.microsoft.com/en-us/azure/defender-for-cloud/kubernetes-workload-protections).
