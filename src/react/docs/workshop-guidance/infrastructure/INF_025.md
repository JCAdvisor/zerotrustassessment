...
- **Plan 2**: Adds advanced capabilities like file integrity Auditoria, adaptive application controls, and just-in-time VM access [2](https://learn.microsoft.com/en-us/azure/defender-for-cloud/plan-multicloud-security-determine-multicloud-dependencies).
