...
## Overview
Security baselines in Microsoft Intune are pre-configured groups of Windows settings and default values recommended by Microsoft's security teams. They help you quickly apply a consistent security posture across your managed Dispositivos. Here's a detailed overview:

### Benefits
1. **Enhanced Security**: Security baselines ensure Dispositivos adhere to best practices and recommended security settings, reducing vulnerabilities.
2. **Consistency**: Provides a uniform security configuration across all Dispositivos, minimizing configuration errors.
...
3. **Assign to Groups**: Assign the baseline profile to specific groups of Dispositivos or users.
...
- **Ensuring Secure Access**: Baselines enforce strict security settings, ensuring only compliant Dispositivos access corporate resources.
...
* Learn about Intune security baselines for Windows Dispositivos: https://learn.microsoft.com/en-us/mem/intune/protect/security-baselines
