...
Assignments: A list of role assignments defining which users have access to which users/Dispositivos. A role can have multiple assignments, and a user can be in multiple assignments.
