...
Single Sign-On (SSO) enables macOS users to authenticate once and gain seamless access to corporate apps and services without repeated credential prompts. In Intune-managed macOS environments, Microsoft supports multiple SSO mechanisms, including the **Enterprise SSO plug-in**, **Platform SSO**, and **Kerberos SSO**. These technologies reduce friction, improve security, and support Zero Trust by enforcing strong, identity-based Controle de Acessos.
...
- **Strengthens identity assurance** by binding authentication to the Dispositivos.  
- **Supports Zero Trust** by ensuring that access is based on verified identity and Dispositivos trust.  
...
- Acts as broker for **Conditional Access**, **Dispositivos compliance**, and **Workplace Join (WPJ)** certificate-based authentication.

> From a Zero Trust perspective:  
> Platform SSO with Secure Enclave ensures **phishing-resistant, hardware-bound authentication**, and guarantees that access is granted only to **verified users on compliant Dispositivos**.

[Learn more](https://learn.microsoft.com/en-us/entra/identity/Dispositivos/macos-psso)
...
[Learn more](https://learn.microsoft.com/en-us/entra/identity/Dispositivos/Dispositivos-join-macos-platform-single-sign-on-kerberos-configuration)
...
## Dispositivos and OS Requirements
...
- Dispositivos must be **Entra-joined** and enrolled in Intune to enable full SSO capabilities.

---

## Zero Trust Considerations

- **Verify explicitly**: Access is granted only after verifying both user identity and Dispositivos trust.  
...
- **Defense in depth**: SSO complements other identity and Dispositivos controls, ensuring layered protection across the authentication stack.  

---

## Recommendations
- **Deploy Platform SSO** with Secure Enclave for all supported macOS Dispositivos.  
...
- [Configure Kerberos SSO with Platform SSO](https://learn.microsoft.com/en-us/entra/identity/Dispositivos/Dispositivos-join-macos-platform-single-sign-on-kerberos-configuration)  
