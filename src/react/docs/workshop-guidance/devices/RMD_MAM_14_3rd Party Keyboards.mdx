...
<iframe width="560" height="315" src="https://www.youtube.com/embed/fu6fioaSjp4?si=4s2-aF2Lw_xvUOI-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- [iOS/iPadOS Dispositivos settings in Microsoft Intune](https://learn.microsoft.com/en-us/intune/intune-service/configuration/Dispositivos-restrictions-ios)
