...
**Account protection** in Microsoft Intune's endpoint security is designed to protect user identities and manage local group memberships on Windows Dispositivos. It includes:
...
- **Local Admin Password Solution (LAPS)**: Manages a single local administrator account per Dispositivos, enforcing password requirements and backing up credentials to Active Directory or Microsoft Entra.
