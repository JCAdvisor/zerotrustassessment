# 110: Tunnel based VPN access for enrolled Dispositivos

## Overview

## Benefits

**Secure Access:** Tunnel-based VPN provides secure access to corporate resources, ensuring that data transmitted between the Dispositivos and the network is encrypted and protected.
...
**Conditional Access Integration:** VPN access can be integrated with conditional access policies, ensuring that only compliant and secure Dispositivos can connect to the corporate network.
...
**Continuous Compliance:** Tunnel-based VPN supports the Zero Trust principle by ensuring that Dispositivos are continuously monitored and compliant with security policies.
...
**Proactive Security:** By integrating with conditional access policies, VPN access helps maintain a proactive security posture, ensuring that only secure and compliant Dispositivos can connect to the network.

## Reference

* **Microsoft Tunnel for Mobile Gerenciamento de Aplicativos for Android** https://learn.microsoft.com/en-us/mem/intune/protect/microsoft-tunnel-mam-android
