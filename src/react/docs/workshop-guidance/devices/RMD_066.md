...
10. On the **App information** page, add details like the app name, description, publisher, App Store URL, minimum operating system version, applicable Dispositivos type, category, and more.
11. Optionally, you can feature the app prominently in the **Company Portal**.
12. Once configured, Intune will automatically install and keep the app updated on users' Dispositivos.
