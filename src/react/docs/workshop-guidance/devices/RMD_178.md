...
Deploying MDM-based policies for Endpoint Detection and Response (EDR) and Antivirus (AV) on macOS Dispositivos using Microsoft Intune involves several steps. Here's a detailed overview:
...
1. **Prerequisites and System Requirements**:
   ...
   - Verify that macOS Dispositivos meet the system requirements¹.

2. **Create System Configuration Profiles**:
   - In the Intune admin center, navigate to **Dispositivos > Configuration profiles**.
...
3. **Approve System Extensions**:
   - Go to **Dispositivos > Configuration profiles** and create a new profile.
...
4. **Deploy Microsoft Defender for Endpoint**:
   ...
   - Deploy the package using Intune by creating a new app and assigning it to the relevant Dispositivos groups.
...
- **Centralized Management**: Simplifies the management of security policies across all macOS Dispositivos from a single console.
- **Compliance**: Helps ensure Dispositivos comply with organizational security policies and regulatory requirements.
...
Deploying MDM-based policies for EDR/AV on macOS Dispositivos aligns with the Zero Trust security model by ensuring that:
...
* Deploy MDM based policies for EDR/AV | Zero Trust Assessment. https://microsoft.github.io/zerotrustassessment/docs/workshop-guidance/Dispositivos/RMD_178.
