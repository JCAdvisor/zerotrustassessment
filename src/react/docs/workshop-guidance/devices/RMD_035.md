...
## Overview
Mobile Gerenciamento de Aplicativos (MAM) in Microsoft Intune provides several data protection settings for Android Dispositivos. Here’s a breakdown of the key options available:
...
- **Access to Dispositivos Features**: Control access to Dispositivos features like the camera or microphone from managed apps.
...
(3) Mobile Gerenciamento de Aplicativos (MAM) and Android Enterprise personally .... https://learn.microsoft.com/en-us/mem/intune/apps/android-deployment-scenarios-app-protection-work-profiles.
