...
## Overview
Intune with Mobile Threat Defense (MTD) helps you detect threats and assess risk on mobile and Windows Dispositivos. You can create an Intune app protection policy that assesses risk to determine if the application is allowed to access corporate data or not.
