...
## Overview
**Role-based Controle de Acesso (RBAC)** in **Microsoft Intune** allows you to manage who has access to your organization's resources and what they can do with those resources. Here's a breakdown:
...
* Deep dive into Role Based Controle de Acesso (RBAC) in Intune. https://techcommunity.microsoft.com/t5/video-hub/deep-dive-into-role-based-access-control-rbac-in-intune/ba-p/1688877.
