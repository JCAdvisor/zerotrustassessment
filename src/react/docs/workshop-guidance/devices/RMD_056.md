...
## Overview
Upload and renew your Apple MDM push certificates in Microsoft Intune. An Apple MDM Push certificate is required to manage iOS/iPadOS and macOS Dispositivos in Microsoft Intune, and enables Dispositivos to enroll via:

*The Intune Company Portal app.

*Apple bulk enrollment methods, such as the Dispositivos Enrollment Program, Apple School Manager, and Apple Configurator.
