...
Remote Help is a secure, cloud-based support tool integrated with Intune that allows IT administrators to remotely assist users on managed Dispositivos. As of 2024, Remote Help is supported on **macOS 12.6 and later**, enabling secure screen sharing and remote control for Intune-enrolled macOS Dispositivos. From a Zero Trust perspective, Remote Help reinforces **identity verification**, **least privilege**, and **auditable support workflows**.
...
- **Supports Zero Trust** by verifying user and Dispositivos identity before session initiation.
...
From a Zero Trust perspective: Ensures that **only managed, compliant Dispositivos** are eligible for remote support.
...
- **Assume breach**: Sessions are limited to managed, compliant Dispositivos and require user consent.
...
- **Defense in depth**: Remote Help complements Dispositivos compliance, RBAC, and Conditional Access.
...
- **Ensure Company Portal is installed** and Dispositivos are enrolled in Intune.
