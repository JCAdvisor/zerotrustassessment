...
With MAA, you configure access policies that protect specific configurations, like Apps or Scripts for Dispositivos. Access policies specify what is protected and which group of accounts are permitted to approve changes to those resources.
...
* Scripts – Applies to deploying scripts to Dispositivos that run Windows.
