...
This feature applies to:
   ...
   Android 8.0 or later for enrolled Dispositivos and Android 9.0 or later for unenrolled Dispositivos
...
App configuration can be delivered either through the mobile Dispositivos management (MDM) OS channel on enrolled Dispositivos (Managed App Configuration channel for iOS or the Android in the Enterprise channel for Android) or through the MAM (Mobile Gerenciamento de Aplicativos) channel. Edge for iOS and Android supports the following configuration scenarios:

*Only allow work or school accounts
*General app configuration settings
*Data protection settings
*Additional app configuration for managed Dispositivos
