...
In Microsoft Intune, administrators can control whether organizational data within managed apps on Android Dispositivos is allowed to be backed up to Android Backup Services. This setting is part of the **App Protection Policy (APP)** configuration for Android and is critical for protecting sensitive corporate data on both BYOD and corporate-enrolled Dispositivos.
