...
When you create a Dispositivos configuration profile, you have two policy types: Templates or the Settings Catalog.

* Settings Catalog lists all the settings you can configure, and all in one place.
* Templates include a logical grouping of settings that configure a feature or concept, like email, kiosk Dispositivos, and Dispositivos firmware.

Use the Endpoint Security node to configure Dispositivos security and to manage security tasks for Dispositivos when those Dispositivos are at risk. The Endpoint security policies are designed to help you focus on the security of your Dispositivos and mitigate risk. The available tasks can help you identify at-risk Dispositivos, to remediate those Dispositivos, and restore them to a compliant or more secure state.

## Reference
* [Dispositivos Configuration](https://learn.microsoft.com/en-us/mem/intune/configuration/Dispositivos-profiles)
