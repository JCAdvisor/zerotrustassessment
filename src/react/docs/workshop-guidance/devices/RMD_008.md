...
3. **Co-Managed Environments**:
   - If you're using co-managed mobile Dispositivos management (MDM) with Microsoft Configuration Manager and Intune, retrieve data from Configuration Manager. The Intune Data Warehouse only contains Intune data.
