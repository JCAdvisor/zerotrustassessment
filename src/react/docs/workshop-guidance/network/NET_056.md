 # Automate Governance, Auditoria, and Response for Azure DDoS Protection
...
Automate Azure DDoS Protection governance by enforcing deployment and continuous Auditoria. 
