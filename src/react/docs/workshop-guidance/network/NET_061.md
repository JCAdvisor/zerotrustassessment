 # Automate Azure Firewall Governance, Auditoria, and Response
...
## Overview
Automate governance of your Azure Firewall deployment and configuration by using Azure Policy, Azure Firewall Manager, and built-in Auditoria integrations. 
...
Ingest the diagnostic logs into Microsoft Sentinel via the built-in Azure Firewall connector and author Sentinel Analytics Rules to generate incidents or trigger playbooks—ensuring continuous, policy-driven Auditoria and response.
