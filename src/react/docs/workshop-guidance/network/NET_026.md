...
- Detailed network traffic logs for Microsoft traffic (including enforced policy details). Dashboards such as relationship maps between users, Dispositivos and endpoints, cross tenant access, and top network destination in use.
