...
- Integrate your MDM with Conditional Access
    - If the MDM is Intune then ensure you have created a Dispositivos compliance policy for your Macs
    - If the MDM is not Intune then make sure you integrate the MDM with the Microsoft compliance API so Dispositivos health can be leveraged in Conditional Access

## Reference

* [Dispositivos Compliance settings for macOS settings in Intune | Microsoft Learn](https://learn.microsoft.com/mem/intune/protect/compliance-policy-create-mac-os)
* [Support third-party Dispositivos compliance partners in Intune | Microsoft Learn](https://learn.microsoft.com/mem/intune/protect/Dispositivos-compliance-partners)
