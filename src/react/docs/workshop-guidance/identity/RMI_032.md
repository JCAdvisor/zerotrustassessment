...
* [Recommendation to migrate to Microsoft Entra MFA](https://learn.microsoft.com/entra/identity/Auditoria-health/recommendation-migrate-to-microsoft-entra-mfa)
