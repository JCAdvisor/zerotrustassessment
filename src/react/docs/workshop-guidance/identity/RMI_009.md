...
An initial step in this journey is to enforce zero trust policies when users connect to the corporate networks via VPN. Most modern VPN products support modern authentication; when configuring the authentication to use Entra, this give you the opportunity to enforce conditional access policies to apply MFA, Dispositivos health, user and session risk, etc. 
