...
* Reduced Endpoint Exposure: By running applications and desktops in data centers rather than on local Dispositivos, the exposure of sensitive data on end-user Dispositivos is minimized.
...
* [Dispositivos identity and desktop virtualization - Microsoft Entra ID](https://learn.microsoft.com/entra/identity/Dispositivos/howto-Dispositivos-identity-virtual-desktop-infrastructure)
