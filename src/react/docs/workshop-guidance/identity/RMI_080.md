...
* [Overview of role-based Controle de Acesso in Microsoft Entra ID](https://learn.microsoft.com/entra/identity/role-based-access-control/custom-overview)
