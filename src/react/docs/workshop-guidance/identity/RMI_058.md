#  Remove DJ Windows clients from Active Directory

## Overview

Migrate domain joined Dispositivos to Entra Joined and drive towards zero domain joined client workstations.
...
- If you choose to replace domain joined Dispositivos with Entra Joined Dispositivos through the natural PC replacement cycle then this effort may take 3-5 years.
