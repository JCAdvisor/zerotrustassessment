#  Enable on-prem remote access for web apps without VPN
...
* Policy Enforcement and Administration: administrators can define application specific policies to enforce strong authentication, Dispositivos posture, etc. 
