...
### To change your logo
Select the Contoso logo and select **Picture Format** in the ribbon. Click **Change Picture > This Dispositivos** and select an image file of your logo. Use a PNG or SVG file whenever possible, as these file formats support transparency.
