...
public class InvokeAssessment : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (string.IsNullOrEmpty(AccessToken))
        {
            ...
            var scopes = new[] {"Agreement.Read.All", "CrossTenantInformation.ReadBasic.All", "Directory.Read.All", "Policy.Read.All", "User.Read", "DispositivosManagementServiceConfig.Read.All",
            "DispositivosManagementConfiguration.Read.All", "DispositivosManagementRBAC.Read.All", "DispositivosManagementApps.Read.All",
