Data Loss Prevention (DLP) policies protect sensitive information by Auditoria, detecting, and preventing the sharing of confidential data across Microsoft 365 workloads including Exchange Online, SharePoint Online, OneDrive, and Microsoft Teams.
