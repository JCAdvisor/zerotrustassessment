...
function Test-Assessment-35005 {
    ...
    if ($errorMsg) {
        ...
        if ($passed) {
            ...
            $testResultMarkdown = "❌ Sensitivity labels are NOT enabled in SharePoint Online and OneDrive. Documents cannot be labeled or protected with encryption/Controle de Acessos.`n`n"
        }
